...
for seed in seeds:
    command = f'python main2.py --lang python --model transformer --bpe_pct 0.5 --batch_size 450 --hid_dim 512 --n_layers 3 --lr 0.0005 --seed {seed}'
...
for lr, seed in zip(lrs, seeds):
    command = f'python sequence_lm.py --lang python --model bow --data code --save_model --lr {lr} --seed {seed}'
    process = subprocess.Popen(command, shell=True)
    process.wait() """
...
for seed in seeds:
    command = f'python sequence_lm.py --lang python --model transformer --save_model --data code --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed {seed}'
    process = subprocess.Popen(command, shell=True)
    process.wait()"""
...
for seed in seeds:
    command = f'python main2.py --lang python --model transformer --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed {seed} --load'
    process = subprocess.Popen(command, shell=True)
    process.wait()"""

"""command = f'python sequence_lm.py --lang python --model transformer --save_model --data desc --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed 1'
process = subprocess.Popen(command, shell=True)
process.wait()"""

"""command = f'python sequence_lm.py --lang 6L-python --model transformer --save_model --data code --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed 1'
process = subprocess.Popen(command, shell=True)
process.wait()"""

"""command = f'python sequence_lm.py --lang 6L-python --model transformer --save_model --data desc --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed 1'
process = subprocess.Popen(command, shell=True)
process.wait()"""

"""command = f'python main2.py --lang python --model transformer --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed 1 --load'
process = subprocess.Popen(command, shell=True)
process.wait()"""

"""command = f'python main2.py --lang 6L-python --model transformer --bpe_pct 0.5 --batch_size 450 --hid_dim 256 --n_layers 3 --lr 0.0005 --seed 1 --load'
process = subprocess.Popen(command, shell=True)
process.wait()"""
